    ...
    <div id="gallery" className="bg-black">
      ...
      <div>
        <div className="flex text-center">
          <div className="w-full p-4 text-black text-2xl bg-white">
            NEXORA MEMORIES
          </div>
          <div className="w-full p-4 text-black text-2xl bg-[#56DFCF]">
            NEXORA MEMORIES
          </div>
          <div className="w-full p-4 text-black text-2xl bg-white">
            NEXORA MEMORIES
        ...
        <div className="text-white px-20">
          <div className="rounded-2xl flex pt-16">
            ...
            />
            <h1 className="text-4xl mx-12">
              LIBURAN KE <br /> TAWANGMANGU
            </h1>
          </div>
